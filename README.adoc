...
[source,bash]
----
java -Duser.language=ru -Djava.awt.headless=true -jar target/gantt-0.1.4-standalone.jar -f svg -i /Users/mike/projects/planning -o :input-folder --delete-puml server  -s 0.0.0.0
